...
@section('page-title', 'Edit Kategori: ' . ($kategoriSarana->nama ?? 'Kategori'))
@section('page-subtitle', 'Perbarui informasi kategori sarana')
...
<div class="page-content">
    ...
    <form action="{{ route('kategori-sarana.update', $kategoriSarana) }}" method="POST" class="form-section">
        @csrf
        @method('PUT')

        <x-form-group
            title="Informasi Kategori Sarana"
            description="Perbarui informasi dasar kategori sarana."
            icon="heroicon-o-tag"
        >
            <x-form-section>
                <div class="form-section__grid form-section__grid--single">
                    <x-input.text
                        ...
                        name="nama"
                        id="nama"
                        :value="old('nama', $kategoriSarana->nama)"
                    ...
                    <div class="form-field form-field--full">
                        <div class="c-input">
                            ...
                            <div class="c-input__control">
                                ...
                                >{{ old('deskripsi', $kategoriSarana->deskripsi) }}</textarea>
                            </div>
                            @error('deskripsi')
