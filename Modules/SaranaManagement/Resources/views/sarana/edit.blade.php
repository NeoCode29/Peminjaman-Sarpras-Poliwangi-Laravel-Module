...
@section('page-title', 'Edit Sarana: ' . ($sarana->nama ?? 'Sarana'))
@section('page-subtitle', 'Perbarui informasi sarana')
...
<div class="page-content">
    ...
    <form action="{{ route('sarana.update', $sarana) }}" method="POST" enctype="multipart/form-data" class="form-section">
        @csrf
        @method('PUT')

        <x-form-group
            title="Informasi Sarana"
            description="Perbarui informasi dasar sarana."
            ...
            <x-form-section>
                <div class="form-section__grid">
                    ...
                    <x-input.text
                        ...
                        name="kode_sarana"
                        id="kode_sarana"
                        :value="old('kode_sarana', $sarana->kode_sarana)"
                        placeholder="Kode unik sarana"
                    ...
                    >
                        @foreach($kategoris as $kategori)
                            <option value="{{ $kategori->id }}" {{ old('kategori_id', $sarana->kategori_id) == $kategori->id ? 'selected' : '' }}>
                                {{ $kategori->nama }}
                            </option>
                        @endforeach
                    </x-input.select>
                    ...
                    <div class="form-field form-field--full">
                        <div class="c-input">
                            ...
                            <div class="c-input__control">
                                ...
                                >{{ old('spesifikasi', $sarana->spesifikasi) }}</textarea>
                            </div>
                            @error('spesifikasi')
                    ...
                    >
                        @php($oldType = old('type', $sarana->type ?? 'pooled'))
                    ...
                    >
                        @php($oldKondisi = old('kondisi', $sarana->kondisi))
                    ...
                    >
                        @php($oldStatus = old('status_ketersediaan', $sarana->status_ketersediaan))
                    ...
                    <div class="form-field form-field--full" id="pooled-breakdown" style="display:none;">
                        <div class="form-section__grid" style="grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 1rem;">
                            <x-input.text
                                ...
                                id="jumlah_tersedia"
                                type="number"
                                :value="old('jumlah_tersedia', $sarana->jumlah_tersedia)"
                                min="0"
                            ...
                            <x-input.text
                                ...
                                id="jumlah_rusak"
                                type="number"
                                :value="old('jumlah_rusak', $sarana->jumlah_rusak)"
                                min="0"
                            ...
                            <x-input.text
                                ...
                                type="number"
                                :value="old('jumlah_maintenance', $sarana->jumlah_maintenance)"
                                min="0"
                            ...
                            <x-input.text
                                ...
                                id="jumlah_hilang"
                                type="number"
                                :value="old('jumlah_hilang', $sarana->jumlah_hilang)"
                                min="0"
                                :error="$errors->first('jumlah_hilang')"
                            />
                        </div>
                        <p class="c-input__helper" style="margin-top: 0.5rem;">
                            Untuk tipe <strong>pooled</strong>, Anda dapat mengatur breakdown jumlah secara manual.
                            Untuk tipe <strong>serialized</strong>, statistik akan dihitung otomatis dari data unit.
                        </p>
                    </div>
                    ...
                    <x-input.text
                        ...
                        id="tahun_perolehan"
                        type="number"
                        :value="old('tahun_perolehan', $sarana->tahun_perolehan)"
                        min="1900"
                        max="{{ date('Y') + 1 }}"
                    ...
                    <x-input.text
                        ...
                        id="nilai_perolehan"
                        type="number"
                        :value="old('nilai_perolehan', $sarana->nilai_perolehan)"
                        min="0"
                        step="0.01"
                    ...
                    <x-input.text
                        ...
                        :value="old('lokasi_penyimpanan', $sarana->lokasi_penyimpanan)"
                    ...
                    <div class="form-field">
                        <x-input.file
                            ...
                            id="foto"
                            accept="image/*"
                            :helper="'Biarkan kosong jika tidak ingin mengganti foto. Maksimal 2MB.'"
                            :existing-url="$sarana->foto_url"
                            existing-remove-name="hapus_foto"
                            existing-remove-label="Hapus foto"
                        />
                        @error('foto')
                            <p class="c-input__helper is-invalid">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-field form-field--full">
                        <div class="c-input">
                            ...
                            <div class="c-input__control">
                                ...
                                >{{ old('keterangan', $sarana->keterangan) }}</textarea>
                            </div>
                            @error('keterangan')
                                <p class="c-input__helper is-invalid">{{ $message }}</p>
                            @enderror
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function toggleBreakdown() {
            if (!typeSelect || !breakdown) return;
