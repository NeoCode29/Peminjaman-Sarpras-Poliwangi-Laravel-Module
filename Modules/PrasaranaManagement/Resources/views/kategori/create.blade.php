...
@section('page-title', 'Tambah Kategori Prasarana Baru')
@section('page-subtitle', 'Buat kategori untuk mengelompokkan prasarana')
...
<div class="page-content">
    ...
    <form action="{{ route('kategori-prasarana.store') }}" method="POST" class="form-section">
        @csrf

        <x-form-group
            title="Informasi Kategori Prasarana"
            description="Lengkapi informasi dasar kategori prasarana."
            icon="heroicon-o-tag"
        >
            <x-form-section>
